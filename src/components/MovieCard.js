...
export const MovieCard = ({data}) => {
  ...
  return (
    <Link to={`/movie/${data.id}`} >
        ...
        <img data-testid='movie-poster' src={`https://www.themoviedb.org/t/p/original/${data.poster_path ? data.poster_path : data.backdrop_path}`} alt="" className='h-[370px]'/>
        ...
        <div className='flex flex-col gap-3'>
            {/* {console.log(data.production_countries[0].iso_3166_1)} */}
            ...
            <p  data-testid='movie-title' className='text-[18px] font-bold text-grey-900'>{data.title}</p>
